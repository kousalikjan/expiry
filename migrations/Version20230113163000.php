 ...
 */
final class Version20230113163000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT NOT NULL, owner_id INT NOT NULL, name VARCHAR(20) NOT NULL, PRIMARY KEY(id))');
